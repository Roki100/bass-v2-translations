lang = {
    ...
    CHORUS_DESCRIPTION: 'Active le filtre chorus',
    NODE_CHORUS_ENABLED: '**Filtre activé :** `Chorus`.',
    NODE_CHORUS_DISABLED: '**Filtre désactivé :** `Chorus`.',
    KARAOKE_DESCRIPTION: 'Active le filtre karaoke',
    NODE_KARAOKE_ENABLED: '**Filtre activé :** `Karaoke`.',
    NODE_KARAOKE_DISABLED: '**Filtre désactivé :** `Karaoke`.',
    PULSATOR_DESCRIPTION: 'Active le filtre pulsator',
    NODE_PULSATOR_ENABLED: '**Filtre activé :** `Pulsator`.',
    NODE_PULSATOR_DISABLED: '**Filtre désactivé :** `Pulsator`.',
    TREMOLO_DESCRIPTION: 'Active le filtre tremolo',
    NODE_TREMOLO_ENABLED: '**Filtre activé :** `Tremolo`.',
    NODE_TREMOLO_DISABLED: '**Filtre désactivé :** `Tremolo`.',
    HSURROUND_DESCRIPTION: 'Active le filtre surround',
    NODE_SURROUND_ENABLED: '**Filtre activé :** `Surround`.',
    NODE_SURROUND_DISABLED: '**Filtre désactivé :** `Surround`.',
    H8BIT_DESCRIPTION: 'Active le filtre 8bit',
    NODE_8BIT_ENABLED: '**Filtre activé :** `8-bit`.',
    NODE_8BIT_DISABLED: '**Filtre désactivé :** `8-bit`.',
    ...
    GIVE_PROPER_VOLUME: (current) => `Merci de donner un volume entre 0 et 500 (%)\nLe volume actuel est: \`${current}%\``,
    ...
    PLAY_BACKEND_ERROR: 'Oups, je n\' ai pu jouer ce son à cause d\'une erreur interne :(. Merci de contacter mon serveur de support **https://discord.gg/By3bvFc**!',
    ...
    // TTS
    TTS_DESCRIPTION: 'Utilise le Text To Speech(texte à voix) et envoie le fichier final',
    TTS_WRONG_LANG: (langs, prefix) => `**Langue non supportée!**\nLangues supportées : \`${langs.join(', ')}\`\nExemple : \`${prefix}tts Bonjour | fr\``,
    TTS_ERROR: 'Une erreur s\'est produite, merci de réessayer',
    TTS_WRONG_TXT_LENGTH: 'Le texte doit être compris entre 1 et 200 caractères !.',
    TTS_NO_ARGS: (prefix, langs) => `**Merci de donner un texte et une langue.**\nExemple : \`${prefix}tts Bonjour | fr\`\nLangues disponibles : \`${langs.join(', ')}\``,
    // IDK
