lang = {
    ...
    TOTAL: 'Totaal',
    CLUSTERS: 'Clusters',
    //EVENTS_RECIEVED: 'Ontvangen evenementen',
    //COMMANDS_USED: 'Gebruikte commando\'s',
    EVENTS_RECIEVED: 'Evenementen',
    COMMANDS_USED: 'Commando\'s',
    ...
    HSURROUND_DESCRIPTION: 'Schakelt de geluids filter surround aan/uit',
    NODE_SURROUND_ENABLED: '**Schakelde de filter in** `Surround`.',
    NODE_SURROUND_DISABLED: '**Stopte de filter** `Surround`.',
    H8BIT_DESCRIPTION: 'Schakelt de geluids filter 8bit aan/uit',
    NODE_8BIT_ENABLED: '**Schakelde de filter in** `8-bit`.',
    NODE_8BIT_DISABLED: '**Stopte de filter** `8-bit`.',
    ...
    GIVE_PROPER_VOLUME: (current) => `Geef me alsjeblieft een geldig volume van 0 tot 500 (%)\nHuidig volume is: \`${current}%\``,
